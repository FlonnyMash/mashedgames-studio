-- =============================================================================
-- Migration: 00010_template_controls
-- Adds slug-level demo control hints to template_metadata.
-- =============================================================================
...
COMMENT ON COLUMN public.template_metadata.controls IS
...
SELECT
  ...
  COALESCE(m.controls, '[]'::jsonb) AS controls,
